...
export class GetLandingApartmentsLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, options: LambdaOptions) {
    ...
    const code = new NodejsFunction(this, "code", {
      path: path.join(__dirname, "../../../functions/lambda/getLandingApartments/index.js"),
    });

    const role = new IamRole(this, "lambda-exec", {
      name: "get-landing-apartments-lambda-api",
    ...
    this.lambda = new LambdaFunction(this, "api", {
      functionName: "get-landing-apartments-lambda-function-api",
    ...
    new Apigatewayv2Route(this, "api-get-route", {
      apiId: options.api.id,
      routeKey: "GET /apartments/landing/get",
