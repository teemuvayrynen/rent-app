...
export class GetUserApartmentsLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, options: LambdaOptions) {
    ...
    const code = new NodejsFunction(this, "code", {
      path: path.join(__dirname, "../../../functions/lambda/getUserApartments/index.js"),
    });

    const role = new IamRole(this, "lambda-exec", {
      name: "get-user-apartments-lambda-api",
    ...
    this.lambda = new LambdaFunction(this, "api", {
      functionName: "get-user-apartments-lambda-function-api",
