...
export class GetApartmentLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, options: LambdaOptions) {
    ...
    const code = new NodejsFunction(this, "code", {
      path: path.join(__dirname, "../../../functions/lambda/getApartment/index.js"),
    });

    const role = new IamRole(this, "lambda-exec", {
      name: "get-apartment-lambda-api",
    ...
    this.lambda = new LambdaFunction(this, "api", {
      functionName: "get-apartment-lambda-function-api",
