...
// index.js
var deleteApartment_exports = {};
__export(deleteApartment_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(deleteApartment_exports);
var data = [
  {
    "id": 1,
  ...
  {
    "id": 6,
    "address": "L\xF6nnrotinkatu 12, Helsinki",
    "size": "55m2",
    "rentDate": {
      "start": "10.5.23",
      "end": "9.11.23"
